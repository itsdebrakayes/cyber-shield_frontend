...
import { ShieldAlert, Search, Plus, Trash2, AlertTriangle, Loader2 } from "lucide-react";
    ...
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-4 pb-24">
        ...
        <div className="mobile-score-card overflow-hidden rounded-2xl p-5">
          ...
          <div className="flex gap-2">
            <Input
              ...
              className="border-transparent bg-white/10 text-white placeholder:text-white/40 text-sm"
            />
            ...
            {isChecking ? (
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-4">
                  <RiskGauge score={lookupResult.score} size={80} />
      ...
      <motion.div variants={item}>
        <div className="flex items-center gap-2 px-1">
          ...
          <h2 className="font-display text-sm font-bold text-foreground">Your Monitored Accounts</h2>
      ...
      <motion.div variants={item}>
        <div className="glass-card flex gap-2 rounded-2xl p-3">
          ...
          <Button size="sm" className="shrink-0"><Plus className="mr-1 h-3.5 w-3.5" /> Monitor</Button>
        </div>
      </motion.div>
