      ...
      <Card>
        <CardContent className="space-y-4 p-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea placeholder="Paste the full email body here…" rows={6} value={body} onChange={(e) => setBody(e.target.value)} />
          </div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
            ...
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="flex items-center gap-2 text-sm"><LinkIcon className="h-4 w-4 text-cyber-blue" /> Extracted URLs</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
            ...
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="flex items-center gap-2 text-sm"><AlertTriangle className="h-4 w-4 text-score-danger" /> Suspicious Patterns</CardTitle>
              </CardHeader>
              <CardContent>
